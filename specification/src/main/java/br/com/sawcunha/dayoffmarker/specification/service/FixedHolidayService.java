...
public interface FixedHolidayService {
    ...
    DayOffMarkerResponse<FixedHolidayResponseDTO> update(final Long fixedHolidayID, final @Valid FixedHolidayRequestDTO fixedHolidayRequestDTO) throws Exception;
