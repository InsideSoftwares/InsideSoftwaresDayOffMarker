package br.com.insidesoftwares.dayoffmarker.commons.logger;

import br.com.insidesoftwares.dayoffmarker.commons.utils.LocaleUtilsBean;
...
public class LogService<T> {
    ...
    @Autowired
    private LocaleUtilsBean localeUtilsBean;
    ...
    private String createMessage(String code, String message, String... args){
        String messageCode = localeUtilsBean.getMessage(code, args);
