...
import br.com.insidesoftwares.dayoffmarker.domain.mapper.country.CountryMapper;
...
class CountrySearchServiceBean implements CountrySearchService {
    ...
    @InsideAudit
    @Override
    public InsideSoftwaresResponseDTO<CountryResponseDTO> findById(final UUID countryID) throws CountryNotExistException {
    ...
    @InsideAudit
    @Override
    public Country findCountryByCountryId(final UUID countryId) {
